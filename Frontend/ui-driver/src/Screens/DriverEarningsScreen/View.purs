              ...
              case initialState.props.subView of
                ST.EARNINGS_VIEW -> do
                  ...
                  then do
                    ...
                    -- modifyScreenState $ DriverEarningsScreenStateType (\driverEarningsScreen -> driverEarningsScreen{data{ anyRidesAssignedEver = anyRidesAssignedEver}, props{weekIndex = 3}})
                  else pure unit
...
earningsView push state = 
  linearLayout
    ...
    , padding $ Padding 16 0 16 70
      ...
      then [ totalEarningsView push state 
