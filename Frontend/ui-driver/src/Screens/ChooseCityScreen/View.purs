...
screen :: ChooseCityScreenState -> ScopedScreen Action ChooseCityScreenState ScreenOutput
screen initialState =
  { initialState
  , view
  , name: "ChooseCity"
