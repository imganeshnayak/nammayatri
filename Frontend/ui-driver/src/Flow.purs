        ...
        ( \homeScreen ->
            homeScreen
              ...
              , props
                ...
                , showCoinsPopup = fromMaybe 0 (fromString $ getValueToLocalStore VISITED_DRIVER_COINS_PAGE) == 0 && appConfig.coinsConfig.enableYatriCoins
                }
              }
        )
...
driverEarningsFlow = do 
  (GlobalState globalState) <- getState
  appConfig <- getAppConfig Constants.appConfig
  let earningScreenSate = globalState.driverEarningsScreen
  ...
  case uiAction of
    EARNINGS_NAV HomeScreenNav  -> homeScreenFlow
    EARNINGS_NAV GoToSubscription -> updateAvailableAppsAndGoToSubs
    EARNINGS_NAV GoToContest -> referralScreenFlow
    EARNINGS_NAV GoToAlerts -> notificationFlow
    EARNINGS_NAV _ -> driverEarningsFlow
    ...
    CONVERT_COIN_TO_CASH state -> do
      ...
      modifyScreenState $ DriverEarningsScreenStateType (\driverEarningsScreen -> driverEarningsScreen{props{showCoinsRedeemedAnim = lottieFile}})
      driverEarningsFlow
