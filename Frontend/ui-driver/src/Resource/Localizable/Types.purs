...
data STR = LETS_GET_STARTED
        ...
        | COMPLETE_FIRST_RIDE_TO_UNLOCK_COINS
        | DESTINATION
        | YOU_DID_NOT_TAKE_ANY_RIDES_ON_THE_SELECTED_DATE
        | CONVERT_COINS
        | CASH_CONVERTED
        | WILL_BE_ADJUSTED_IN_YOUR_FUTURE_SUBSCRIPTION_DUES
        | HAS_BEEN_ADJUSTED_IN_YOUR_SUBSCRIPTION_DUES
        | USING_COINS_REQUIRES_AN_ACTIVE_PLAN
        | CHOOSE_A_PLAN_TO_GET_STARTED
        | CONVERTED_FROM_COINS
        | REPORT_AN_ISSUE
        | TIME_TAKEN
        | MAPS
        | CALL
        ...
        | GUARANTEED_FIXED_PRICE
        | INTRODUCTORY_OFFER_TO_BE_ANNOUNCED_SOON
        | NO_CHARGES_TILL
        | AND
        | EARNINGS
        | YATRI_COINS
        | INTRODUCING_YATRI_COINS
        ...
        | BUY_NOW
        | SELECT_DATE
        | WHAT_WILL_MY_COINS_BE_CONVERTED_TO
        | COINS_EXPIRING_IN_THE_NEXT
        | DAYS_USE_THEM_BEFORE_THEY_EXPIRE
        | COINS_EXPIRING
        | NO_COINS_AVAILABLE
        | FAILED_TO_USE_COINS_PLEASE_TRY_AGAIN_LATER
        ...
        | VIEW_MORE
        | MINIMUM
        | COINS_IS_REQUIRED_FOR_CONVERSION
        | DISCOUNT
...
getStringFromEnum key = case key of
    ...
    NO_COINS_EARNED -> "NO_COINS_EARNED"
    REPORT_AN_ISSUE -> "REPORT_AN_ISSUE"
    NO_COINS_USED -> "NO_COINS_USED"
    EARN_COINS_BY_TAKING_RIDES_AND_REFERRING_THE_APP_TO_OTHERS -> "EARN_COINS_BY_TAKING_RIDES_AND_REFERRING_THE_APP_TO_OTHERS"
    ...
    COMPLETE_FIRST_RIDE_TO_UNLOCK_COINS -> "COMPLETE_FIRST_RIDE_TO_UNLOCK_COINS"
    DESTINATION -> "DESTINATION"
    YOU_DID_NOT_TAKE_ANY_RIDES_ON_THE_SELECTED_DATE -> "YOU_DID_NOT_TAKE_ANY_RIDES_ON_THE_SELECTED_DATE"
    ...
    USING_COINS_REQUIRES_AN_ACTIVE_PLAN -> "USING_COINS_REQUIRES_AN_ACTIVE_PLAN"
    CHOOSE_A_PLAN_TO_GET_STARTED -> "CHOOSE_A_PLAN_TO_GET_STARTED"
    CONVERTED_FROM_COINS -> "CONVERTED_FROM_COINS"
    ...
    LOW_DUES_BANNER_TITLE -> "LOW_DUES_BANNER_TITLE"
    ...
    MIN_LEFT -> "MIN_LEFT"
    GET_READY_FOR_YS_SUBSCRIPTION -> "GET_READY_FOR_YS_SUBSCRIPTION"
    SIGNUP_EARLY_FOR_SPECIAL_OFFERS -> "SIGNUP_EARLY_FOR_SPECIAL_OFFERS"
    GUARANTEED_FIXED_PRICE -> "GUARANTEED_FIXED_PRICE"
    ...
    INTRODUCING_YATRI_COINS -> "INTRODUCING_YATRI_COINS"
    NOW_EARN_COINS_FOR_EVERY_RIDE_AND_REFERRAL_AND_USE_THEM_TO_GET_REWARDS -> "NOW_EARN_COINS_FOR_EVERY_RIDE_AND_REFERRAL_AND_USE_THEM_TO_GET_REWARDS"
    PAID_BY_YATRI_COINS -> "PAID_BY_YATRI_COINS"
    YATRI_COINS_USAGE_POPUP -> "YATRI_COINS_USAGE_POPUP"
    USE_COINS_NOW -> "USE_COINS_NOW"
    BUY_NOW -> "BUY_NOW"
    SELECT_DATE -> "SELECT_DATE"
    WHAT_WILL_MY_COINS_BE_CONVERTED_TO -> "WHAT_WILL_MY_COINS_BE_CONVERTED_TO"
    COINS_EXPIRING_IN_THE_NEXT -> "COINS_EXPIRING_IN_THE_NEXT"
    DAYS_USE_THEM_BEFORE_THEY_EXPIRE -> "DAYS_USE_THEM_BEFORE_THEY_EXPIRE"
    COINS_EXPIRING -> "COINS_EXPIRING"
    NO_COINS_AVAILABLE -> "NO_COINS_AVAILABLE"
    FAILED_TO_USE_COINS_PLEASE_TRY_AGAIN_LATER -> "FAILED_TO_USE_COINS_PLEASE_TRY_AGAIN_LATER"
    ...
    VIEW_MORE -> "VIEW_MORE"
    MINIMUM -> "MINIMUM"
    COINS_IS_REQUIRED_FOR_CONVERSION -> "COINS_IS_REQUIRED_FOR_CONVERSION"
    DISCOUNT -> "DISCOUNT"
