const englishStrings = {
  ...
  NO_COINS_EARNED: "No Coins Earned",
  NO_COINS_USED: "No Coins Used",
  EARN_COINS_BY_TAKING_RIDES_AND_REFERRING_THE_APP_TO_OTHERS: "Earn coins by taking rides and referring\nthe app to others",
  ...
  COMPLETE_FIRST_RIDE_TO_UNLOCK_COINS: "Complete first ride to unlock coins",
  DESTINATION: "Destination",
  YOU_DID_NOT_TAKE_ANY_RIDES_ON_THE_SELECTED_DATE: "You did not take any rides on the selected date",
  CONVERT: "Convert",
  CASH_CONVERTED: "Cash Converted",
  WILL_BE_ADJUSTED_IN_YOUR_FUTURE_SUBSCRIPTION_DUES: "will be adjusted in your future subscription dues",
  HAS_BEEN_ADJUSTED_IN_YOUR_SUBSCRIPTION_DUES: "has been adjusted in your\nsubscription dues",
  USING_COINS_REQUIRES_AN_ACTIVE_PLAN: "Using Coins requires an active plan.",
  CHOOSE_A_PLAN_TO_GET_STARTED: "Choose a plan to get started!",
  CONVERTED_FROM_COINS: "converted from coins.",
  ...
  INTRODUCING_YATRI_COINS : "Introducing Yatri Coins",
  NOW_EARN_COINS_FOR_EVERY_RIDE_AND_REFERRAL_AND_USE_THEM_TO_GET_REWARDS : "Now earn coins for every ride and referral, and use them to get rewards",
  PAID_BY_YATRI_COINS : "paid by Yatri Coins",
  YATRI_COINS_USAGE_POPUP : "Yatri Coins will be converted into discounts that you can avail against your subscription plan.",
  USE_COINS_NOW : "Use Coins Now",
  BUY_NOW : "Buy Now",
  SELECT_DATE : "Select Date",
  WHAT_WILL_MY_COINS_BE_CONVERTED_TO : "What will my Coins be converted to?",
  COINS_EXPIRING_IN_THE_NEXT : "coins expiring in the next",
  DAYS_USE_THEM_BEFORE_THEY_EXPIRE : "days. Use them before they expire",
  COINS_EXPIRING : "Coins expiring!",
  NO_COINS_AVAILABLE : "No Coins Available",
  FAILED_TO_USE_COINS_PLEASE_TRY_AGAIN_LATER : "Failed to use coins. Please try again later",
  ...
  VIEW_MORE : "View More",
  MINIMUM : "Minimum",
  COINS_IS_REQUIRED_FOR_CONVERSION : "coins is required for conversion",
  DISCOUNT : "Discount",
  CHECK_NOW : "Check Now",
}
