...
suffixTitleImageView push config =  
  imageView
    [ height MATCH_PARENT
    , width $ V 81
    , imageWithFallback $ "ny_ic_suv_right," <> (getAssetStoreLink FunctionCall) <> "ny_ic_suv_right.png"
    , weight 0.0
    , gravity RIGHT
    ]
...
rentalPackageView push config = 
  linearLayout
    ...
    , imageView
        [ height $ V 118
        , width MATCH_PARENT
        , imageWithFallback $ "ny_ic_ratecard," <> (getAssetStoreLink FunctionCall) <> "ny_ic_ratecard.png"
        , margin $ MarginVertical 12 12
        , gravity CENTER
        ]
