  ...
  linearLayout 
    ...
    , margin $ MarginTop 40
        ...
        [ imageView
          [ width MATCH_PARENT
          , height $ V 180 
          , imageWithFallback $ "ny_ic_ride_scheduled," <>  ( HU.getAssetStoreLink FunctionCall) <> "ny_ic_ride_scheduled.png"
          ]
        , textView $
          [ width MATCH_PARENT
          , height WRAP_CONTENT
...
notificationView push state  =
  ...
  [ imageView 
    [ imageWithFallback $ "ny_ic_alarm," <> (getAssetStoreLink FunctionCall) <> "ny_ic_alarm.png"
    , height $ V 14
    , width $ V 12
...
cancelledRideView push state =
  ...
  [ imageView [
      imageWithFallback $ "ny_ic_ride_cancelled," <> (getAssetStoreLink FunctionCall) <> "ny_ic_ride_cancelled.png"
    , width MATCH_PARENT
