...
settingsView state push =
  ...
  , orientation VERTICAL
        ...
        "NammaSafety" -> settingsMenuView {imageUrl : fetchImage FF_COMMON_ASSET "ny_ic_shield_heart", text : (getString NAMMA_SAFETY), accessibilityHint : "Namma Safety ", tag : SETTINGS_NAMMASAFETY, iconUrl : fetchImage FF_ASSET "ic_red_icon"} push
