...
getBN stringKey =
    case stringKey of
        ...
        EDIT_ACTIONS -> "ক্রিয়া সম্পাদনা করুন"
        ...
        SHARE_LOCATION_AND_RIDE_DETAILS_WITH_NAMMA_YATRI_SUPPORT_TEAM -> "নম্মা যাত্রী সাপোর্ট টিমের সাথে অবস্থান এবং রাইডের বিবরণ শেয়ার করুন"
        ACTIVATE_LIVE_VIDEO_RECORDING_FEATURES -> "লাইভ ভিডিও রেকর্ডিং বৈশিষ্ট্য সক্রিয় করুন"
        GET_OPTIONS_TO_DIRECTLY_CALL_SUPPORT -> "সরাসরি সহায়তা / পুলিশকে কল করার বিকল্পগুলি পান"
        ...
        TRIGGER_ALERT_TO_NAMMA_YATRI_SUPPORT -> "নম্মযাত্রী সমর্থনে সতর্কতা ট্রিগার করুন"
        NIGHT_TIME_SAFETY_CHECKS -> "রাতের সময় নিরাপত্তা পরীক্ষা"
        SHARE_INFO_WITH_EMERGENCY_CONTACTS_TITLE -> "জরুরি পরিচিতিদের সাথে তথ্য শেয়ার করবেন?"
        SHARE_INFO_WITH_EMERGENCY_CONTACTS_DESC -> "নিরাপত্তা মোড অ্যাক্টিভেশনে, রাইডের তথ্য নিচের জরুরি পরিচিতিদের সাথে স্বয়ংক্রিয়ভাবে শেয়ার করা হবে।"
        TRIGGER_ALERT_TO_NAMMAYATRI_SUPPORT_TITLE -> "নম্মযাত্রী সমর্থনে সতর্কতা ট্রিগার করুন"
        ...
        ENABLE_NIGHT_TIME_SAFETY_ALERTS_DESC -> "আপনার নিরাপত্তা নিশ্চিত করতে, 9 PM-6AM থেকে, আমরা চালকের রুটের অসঙ্গতি সনাক্তকরণের ভিত্তিতে নিরাপত্তা চেক সতর্কতা পাঠাব। রুট-বিচ্যুতি বা যানবাহন চলাচল না করার ক্ষেত্রে।\n\n • এটি ঘটবে নিরাপত্তা মোড সক্রিয় কিনা নির্বিশেষে"
        ALMOST_DONE_TITLE -> "প্রায় হয়ে গেছে!"
        ALMOST_DONE_DESC -> "জরুরি অবস্থায়, আপনি পুলিশ হেল্পলাইনেও যোগাযোগ করতে পারেন (112)। এটি করতে, অনুগ্রহ করে প্রয়োজনীয় অনুমতি প্রদান করুন"
        PERSONAL_SAFETY_SETTINGS_ACTIONS -> " • 112 এ কল করুন\n • নম্মযাত্রী সমর্থনে কল করুন\n • ভিডিও রেকর্ড করুন"
        ...
        SAFETY_MEASURE_5 -> "সমস্ত নম্মা যাত্রী চালকের জন্য নিরাপত্তা প্রশিক্ষণ এবং সার্টিফিকেশন"
        ...
        ABOUT_SOS_11 -> "জরুরী ভাগ করে নেওয়ার মাধ্যমে আপনার পরিবার এবং বন্ধুদের/ নম্মা যাত্রী সহায়তাকে জানান।"
        ...
        DISMISS -> "খারিজ করুন"
        SEND_SILENT_SOS_TO_POLICE -> "পুলিশকে নীরব SOS পাঠান"
        ...
        SHARE_SOS_SILENTLY_WITH_POLICE -> "পুলিশের সাথে SOS নীরবে শেয়ার করুন"
        SAFETY_PLUS_IS_ACTIVE_NOW -> "নিরাপত্তা+ এখন সক্রিয়!"
        SAFETY_PLUS_ACTIVE_DESC -> "দয়া করে শান্ত থাকুন। আপনার এসওএস অনুরোধ আপনার জরুরি পরিচিতিদের পাঠানো হয়েছে। আপনি এটিও বেছে নিতে পারেন "
        CALL_AND_ALERT_THE_NEAREST_POLICE_CENTRE -> "কল করুন এবং নিকটতম পুলিশ কেন্দ্রে সতর্ক করুন।"
        SEND_A_SILENT_SOS_TO_THE_POLICE -> "পুলিশকে একটি নীরব SOS বার্তা পাঠান।"
        SEND_A_VIDEO_RECORDING_TO_POLICE -> "পুলিশের কাছে একটি ভিডিও রেকর্ডিং পাঠান।"
        LEARN_ABOUT_NAMMA_SAFETY_PLUS -> "নিরাপত্তা+ সম্পর্কে জানুন"
        NAMMA_SAFETY_WILL_ENABLE_ACCESS_PLUS -> "সেফটি+ রাইডের সময় নিম্নলিখিত বৈশিষ্ট্যগুলিতে অ্যাক্সেস সক্ষম করবে!"
        WHEN_YOU_START_EMERGENCY_SOS_PLUS -> "যখন আপনি Safety+ সক্রিয় করবেন, তখন আপনার অ্যাপ্লিকেশানটি নিচের কাজগুলি সম্পাদন করবে"
        ABOUT_SOS_DESC_PLUS -> "দয়া করে সেফটি+ এর জটিলতা বুঝুন। অ-গুরুত্বপূর্ণ পরিস্থিতির জন্য, অনুগ্রহ করে একটি অভিযোগ জানাতে <b>সহায়তা ও সমর্থন</b> বিভাগটি ব্যবহার করুন।"
        NAMMA_SAFETY_MEASURES_PLUS -> "নিরাপত্তা + ব্যবস্থা"
        ABOUT_SOS_PLUS -> "নিরাপত্তা+ সম্পর্কে"
        SHARE_INFO_WITH_EMERGENCY_CONTACTS_DESC_PLUS -> "সেফটি+ অ্যাক্টিভেশনে, রাইডের তথ্য নিচের জরুরি পরিচিতিদের সাথে স্বয়ংক্রিয়ভাবে শেয়ার করা হবে।"
        SAFETY_MEASURE_2_PLUS -> "নিরাপত্তা+ বোতাম।"
        ABOUT_SOS_9_PLUS -> "রাইডের সময় সেফটি+ বোতামে ট্যাপ করে নিরাপত্তা+ সক্রিয় করুন"
        NAMMA_SAFETY_IS_SET_UP_PLUS -> "নিরাপত্তা+ সফলভাবে সেট আপ হয়েছে"
        ACTIVATE_NAMMA_SAFETY_POPUP_TITLE_PLUS -> "আপনি সক্রিয় করতে চলেছেন\nSafety+"
        ACTIVATE_NAMMA_SAFETY_POPUP_DESC_PLUS -> "আপনার নিরাপত্তা আমাদের সর্বোচ্চ অগ্রাধিকার। শুধুমাত্র সত্যিকারের জরুরী পরিস্থিতিতে নিরাপত্তা+ ব্যবহার করুন। অপব্যবহার প্রকৃত সংকটময় পরিস্থিতি থেকে সম্পদকে সরিয়ে দিতে পারে"
        ABOUT_SOS_12_PLUS -> "আপনি পুলিশ হেল্পলাইনে কল করতে পারেন (112) অথবা একই সাথে একটি নীরব SOS পাঠাতে পারেন"
        SAFETY_MEASURE_5_PLUS -> "সমস্ত যাত্রী সাথী চালকদের জন্য নিরাপত্তা প্রশিক্ষণ এবং সার্টিফিকেশন"
        SHARE_LOCATION_AND_RIDE_DETAILS_WITH_NAMMA_YATRI_SUPPORT_TEAM_PLUS -> "যাত্রী সাথী সাপোর্ট টিমের সাথে অবস্থান এবং রাইডের বিবরণ শেয়ার করুন"
        NAMMA_SAFETY_PLUS -> "নিরাপত্তা+"
        TRIGGER_ALERT_TO_NAMMA_YATRI_SUPPORT_PLUS -> "যাত্রী সাথী সমর্থনে ট্রিগার সতর্কতা"
        TRIGGER_ALERT_TO_NAMMAYATRI_SUPPORT_TITLE_PLUS -> "যাত্রী সাথী সমর্থনে ট্রিগার সতর্কতা"
        SAFETY_GUIDELINES_6_PLUS -> "অ্যাপ জরুরী নিরাপত্তা+ বৈশিষ্ট্য ব্যবহার করুন"
        PERSONAL_SAFETY_SETTINGS_ACTIONS_PLUS -> " • পুলিশকে কল করুন (112)\n • পুলিশকে নীরব SOS পাঠান\n • একটি ছোট 15 সেকেন্ডের ভিডিও রেকর্ড করুন।"
        ENABLE_NIGHT_TIME_SAFETY_ALERTS_DESC_PLUS -> "আপনার নিরাপত্তা নিশ্চিত করতে, 9 PM-6AM থেকে, আমরা চালকের রুটের অসঙ্গতি সনাক্তকরণের ভিত্তিতে নিরাপত্তা চেক সতর্কতা পাঠাব। রুট-বিচ্যুতির ক্ষেত্রে বা গাড়ি চলাচল না করার ক্ষেত্রে।\n\n • এটি ঘটবে সেফটি+ সক্রিয় করা হোক না কেন"
        ALMOST_DONE_DESC_PLUS -> "জরুরী অবস্থার সময়, পরিস্থিতির জটিলতার উপর ভিত্তি করে এই পদক্ষেপগুলির যেকোনো একটি নেওয়া যেতে পারে"
        SEND_VIDEO_TO_POLICE -> "15s ভিডিও\nপুলিশকে পাঠান"
        FINISH_SETUP -> "সেটআপ শেষ করুন"
        ACTIVATE_SOS -> "SOS সক্রিয় করুন"
        ...
        CALL_SUPPORT_FOR_SAFETY -> "আমাদের\nসমর্থনকে কল করুন"
        SAFETY_MEASURE_6 -> "সমস্ত নম্মা যাত্রী চালকের জন্য নিরাপত্তা প্রশিক্ষণ এবং সার্টিফিকেশন"