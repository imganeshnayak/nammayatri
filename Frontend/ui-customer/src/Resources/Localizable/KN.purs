...
getKN stringKey =
    case stringKey of
        ...
        EDIT_ACTIONS -> "ಕ್ರಿಯೆಗಳನ್ನು ಸಂಪಾದಿಸಿ"
        ...
        EMERGENCY_SHARING_WITH_CONTACTS -> "ಆಪತ್ಕಾಲ ಸಂಪರ್ಕಗಳೊಂದಿಗೆ ಹಂಚಿಕೊಳ್ಳಲು"
        ...
        SOS_ACTIONS -> "SOS ಕ್ರಿಯೆಗಳು"
        CALL_POLICE -> "ಪೋಲಿಸ್ ಸಹಾಯದಾಳಕ್ಕೆ ಕರೆ ಮಾಡಿ\n(112)"
        ...
        SHARE_LOCATION_AND_RIDE_DETAILS_WITH_NAMMA_YATRI_SUPPORT_TEAM -> "ನಮ್ಮ ಯಾತ್ರಿ ಬೆಂಬಲ ತಂಡದೊಂದಿಗೆ ಸ್ಥಳವನ್ನು ಮತ್ತು ಸವಾರಿ ವಿವರಗಳನ್ನು ಹಂಚಿಕೊಳ್ಳಿ"
        ACTIVATE_LIVE_VIDEO_RECORDING_FEATURES -> "ಪ್ರತಿಕ್ರಿಯಿಸಲು ಲೈವ್ ವೀಡಿಯೊ ರಿಕಾರ್ಡಿಂಗ್ ವೈಶಿಷ್ಟ್ಯಗಳನ್ನು ಸಕ್ರಿಯಗೊಳಿಸಿ"
        GET_OPTIONS_TO_DIRECTLY_CALL_SUPPORT -> "ಬೆಂಬಲ/ಪೋಲೀಸ್‌ಗೆ ಸಂಪರ್ಕ ಸೆಳೆಯಲು ಆಯ್ಕೆಗಳನ್ನು ಪಡೆಯಿರಿ"
        ...
        SAFETY_GUIDELINES_FOR_YOU -> "ನಿಮಗಾಗಿ ಸುರಕ್ಷಾ ಮಾರ್ಗದರ್ಶನೆಗಳು"
        ABOUT_SOS -> "ಸುರಕ್ಷಾ ಮೋಡ್ ಬಗ್ಗೆ"
        TRIGGER_ALERT_TO_NAMMA_YATRI_SUPPORT -> "ನಮ್ಮ ಯಾತ್ರಿ ಬೆಂಬಲಕ್ಕೆ ಎಚ್ಚರಿಸಲು ಸುರುಳಿ ಹಾಕಿ"
        NIGHT_TIME_SAFETY_CHECKS -> "ರಾತ್ರಿ ಸುರಕ್ಷಾ ಪರಿಶೀಲನೆಗಳು"
        SHARE_INFO_WITH_EMERGENCY_CONTACTS_TITLE -> "ಆಪತ್ಕಾಲ ಸಂಪರ್ಕಗಳೊಂದಿಗೆ ಮಾಹಿತಿ ಹಂಚಿಕೊಳ್ಳಬೇಕು?"
        SHARE_INFO_WITH_EMERGENCY_CONTACTS_DESC -> "ಸುರಕ್ಷಾ ಮೋಡ್ ಸಕ್ರಿಯಗೊಂಡಾಗ, ಸವಾರಿ ಮಾಹಿತಿಯನ್ನು ಕೆಳಗಿನ ಆಪತ್ಕಾಲ ಸಂಪರ್ಕಗಳೊಂದಿಗೆ ಸ್ವಯಂಚಾಲಿತವಾಗಿ ಹಂಚಿಕೊಳ್ಳಲಾಗುತ್ತದೆ."
        TRIGGER_ALERT_TO_NAMMAYATRI_SUPPORT_TITLE -> "ನಮ್ಮ ಯಾತ್ರಿ ಬೆಂಬಲಕ್ಕೆ ಸುರುಳಿ ಹಾಕಿ"
        ...
        ENABLE_NIGHT_TIME_SAFETY_ALERTS_DESC -> "ನಿಮ್ಮ ಸುರಕ್ಷೆಯನ್ನು ಖಚಿತಪಡಿಸಲು, 9 PM-6AM ರವರೆಗೆ, ಡ್ರೈವರ್‌ನ ಮಾರ್ಗದರ್ಶನದ ವ್ಯತ್ಯಯದ ಆಧಾರದಿಂದ ಸುರಕ್ಷಾ ಪರಿಶೀಲನೆ ಎಚ್ಚರಿಕೆಗಳನ್ನು ಕಳುಹಿಸುತ್ತೇವೆ. ಮಾರ್ಗದರ್ಶನದ ವಿಪರೀತತೆ ಅಥವಾ ವಾಹನವು ಸಾಗುತ್ತಿಲ್ಲದಾಗ.\n\n • ಇದು ಸುರಕ್ಷಾ ಮೋಡ್ ಸಕ್ರಿಯಗೊಳ್ಳಿದರೂ ಆಗುತ್ತದೆ"
        ALMOST_DONE_TITLE -> "ಸಮೀಪದಲ್ಲಿ ಮುಗಿದಿದೆ!"
        ALMOST_DONE_DESC -> "ಆಪತ್ಕಾಲದಲ್ಲಿ, ನೀವು ಪೋಲೀಸ್ ಸಹಾಯ ಹೆಲ್ಪ್‌ಲೈನ್ (112) ಗೆ ಸಂಪರ್ಕ ಮಾಡಬಹುದು. ಇದನ್ನು ಮಾಡಲು, ಅಗತ್ಯವಾದ ಅನುಮತಿಗಳನ್ನು ನೀಡಿ"
        PERSONAL_SAFETY_SETTINGS_ACTIONS -> " • 112 ಕೋಲ್ ಮಾಡಿ\n • ನಮ್ಮ ಬೆಂಬಲಕ್ಕೆ ಕರೆ ಮಾಡಿ\n • ವೀಡಿಯೊ ರಿಕಾರ್ಡ್ ಮಾಡಿ"
        ...
        SAFETY_MEASURE_5 -> "ಎಲ್ಲಾ ನಮ್ಮ ಯಾತ್ರಿ ಡ್ರೈವರ್ಗಳಿಗಾಗಿ ಸುರಕ್ಷಾ ಅಭ್ಯಾಸ ಮತ್ತು ಪ್ರಮಾಣಪತ್ರಗಳು"
        ...
        ABOUT_SOS_11 -> "ಆಪಿಸಿನ ಹಂಚಿಕೊಳ್ಳಿ, ನಿಮ್ಮ ಕುಟುಂಬ ಮತ್ತು ಸ್ನೇಹಿತರಿಗೆ / ನಮ್ಮ ಯಾತ್ರಿ ಬೆಂಬಲದಿಂದ."
        ...
        ACTIVATE_NAMMA_SAFETY_POPUP_ACTION -> "ಸಕ್ರಿಯಗೊಳಿಸುತ್ತಿದ್ದೀರಿ ದೃ confirmActivation"
        DISMISS -> "ತಿರಸ್ಕರಿಸಿ"
        ...
        SAFETY_PLUS_IS_ACTIVE_NOW -> "ಸುರಕ್ಷತೆ+ ಈಗ ಸಕ್ರಿಯವಾಗಿದೆ!"
        SAFETY_PLUS_ACTIVE_DESC -> "ದಯವಿಟ್ಟು ಶಾಂತವಾಗಿರಿ. ನಿಮ್ಮ SOS ವಿನಂತಿಯನ್ನು ನಿಮ್ಮ ತುರ್ತು ಸಂಪರ್ಕಗಳಿಗೆ ಕಳುಹಿಸಲಾಗಿದೆ. ನೀವು "
        CALL_AND_ALERT_THE_NEAREST_POLICE_CENTRE -> "ಹತ್ತಿರದ ಪೊಲೀಸ್ ಕೇಂದ್ರಕ್ಕೆ ಕರೆ ಮಾಡಿ ಮತ್ತು ಎಚ್ಚರಿಸಿ."
        SEND_A_SILENT_SOS_TO_THE_POLICE -> "ಪೊಲೀಸರಿಗೆ ಮೂಕ SOS ಸಂದೇಶವನ್ನು ಕಳುಹಿಸಿ."
        SEND_A_VIDEO_RECORDING_TO_POLICE -> "ಪೊಲೀಸರಿಗೆ ವೀಡಿಯೊ ರೆಕಾರ್ಡಿಂಗ್ ಕಳುಹಿಸಿ."
        LEARN_ABOUT_NAMMA_SAFETY_PLUS -> "ಸುರಕ್ಷತೆ+ ಬಗ್ಗೆ ತಿಳಿಯಿರಿ"
        NAMMA_SAFETY_WILL_ENABLE_ACCESS_PLUS -> "ರೈಡ್ ಸಮಯದಲ್ಲಿ ಸುರಕ್ಷತೆ+ ಈ ಕೆಳಗಿನ ವೈಶಿಷ್ಟ್ಯಗಳಿಗೆ ಪ್ರವೇಶವನ್ನು ಸಕ್ರಿಯಗೊಳಿಸುತ್ತದೆ!"
        WHEN_YOU_START_EMERGENCY_SOS_PLUS -> "ನೀವು ಸುರಕ್ಷತೆ+ ಅನ್ನು ಸಕ್ರಿಯಗೊಳಿಸಿದಾಗ, ನಿಮ್ಮ ಅಪ್ಲಿಕೇಶನ್ ಕೆಳಗಿನ ಕ್ರಿಯೆಗಳನ್ನು ನಿರ್ವಹಿಸುತ್ತದೆ"
        ABOUT_SOS_DESC_PLUS -> "ದಯವಿಟ್ಟು ಸೇಫ್ಟಿ+ ಯ ಕ್ರಿಟಿಕಲಿಟಿ ಅರಿವಿಗೆ ಹೊಂದಿ. ಗಂಭೀರ ಸನ್ನಿವೇಶಗಳಲ್ಲಿ, ದಯವಿಟ್ಟು <b>ಸಹಾಯ ಮತ್ತು ಬೆಂಬಲ</b> ವಿಭಾಗವನ್ನು ಉಪಯೋಗಿಸಿ ನಿರ್ದೇಶನ ನೀಡಲಾಗಿದೆ."
        NAMMA_SAFETY_MEASURES_PLUS -> "ಸುರಕ್ಷತೆ+ ಕ್ರಮಗಳು"
        ABOUT_SOS_PLUS -> "ಸುರಕ್ಷತೆ+ ಬಗ್ಗೆ"
        SHARE_INFO_WITH_EMERGENCY_CONTACTS_DESC_PLUS -> "ಸುರಕ್ಷತೆ+ ಸಕ್ರಿಯಗೊಳಿಸುವಿಕೆಯಲ್ಲಿ, ಕೆಳಗಿನ ತುರ್ತು ಸಂಪರ್ಕಗಳೊಂದಿಗೆ ಸವಾರಿ ಮಾಹಿತಿಯನ್ನು ಸ್ವಯಂ ಹಂಚಿಕೊಳ್ಳಲಾಗುತ್ತದೆ."
        SAFETY_MEASURE_2_PLUS -> "ಸುರಕ್ಷತೆ+ ಬಟನ್."
        ABOUT_SOS_9_PLUS -> "ರೈಡ್ ಸಮಯದಲ್ಲಿ ಸುರಕ್ಷತೆ+ ಬಟನ್ ಮೇಲೆ ಟ್ಯಾಪ್ ಮಾಡುವ ಮೂಲಕ ಸುರಕ್ಷತೆ+ ಅನ್ನು ಸಕ್ರಿಯಗೊಳಿಸಿ"
        NAMMA_SAFETY_IS_SET_UP_PLUS -> "ಸುರಕ್ಷತೆ+ ಅನ್ನು ಯಶಸ್ವಿಯಾಗಿ ಹೊಂದಿಸಲಾಗಿದೆ"
        ACTIVATE_NAMMA_SAFETY_POPUP_TITLE_PLUS -> "ನೀವು ಸೇಫ್ಟಿ+ ಅನುಸರಿಸಲು ಸಜ್ಜಾಗಿದ್ದೀರಿ"
        ACTIVATE_NAMMA_SAFETY_POPUP_DESC_PLUS -> "ನಿಮ್ಮ ಭರವಸೆ ನಮ್ಮ ಪ್ರಧಾನ ಆದಾಯ. ಸೇಫ್ಟಿ+ ನನ್ನೀರು ವಾಸ್ತವಿಕ ಆಪತ್ಕಾಲದಲ್ಲಿ ಮಾತ್ರ ಬಳಸಿ. ತಪ್ಪಾಗಿ ಬಳಸಿದರೆ ನಿಜವಾದ ಗಂಭೀರ ಸನ್ನಿವೇಶಗಳಿಂದ ಸಾಧನೆ ಸೆಳೆಯಬಹುದು"
        ABOUT_SOS_12_PLUS -> "ನೀವು ಪೋಲೀಸ್ ಹೆಲ್‌ಪ್‌ಲೈನ್ (112) ಅನ್ನು ಕರೆಯಬಹುದು ಅಥವಾ ಸ್ವಾಂತ ಎಸೊಎಸ್ ಕಳುಹಿಸಲಾಗಿದೆ"
        SAFETY_MEASURE_5_PLUS -> "ಎಲ್ಲಾ ಯಾತ್ರಿ ಸಾಥಿ ಡ್ರೈವರ್ಗೆ ಸೇಫ್ಟಿ ತರಬೇತು ಮತ್ತು ಪ್ರಮಾಣಪತ್ರ"
        SHARE_LOCATION_AND_RIDE_DETAILS_WITH_NAMMA_YATRI_SUPPORT_TEAM_PLUS -> "ನಮ್ಮ ಸಹಾಯ ತಂಡದಿಂದ ಸ್ಥಾನ ಹಂಚಿಕೊಳ್ಳಿ ಮತ್ತು ರೈಡ್ ವಿವರಗಳನ್ನು ಹಂಚಿಕೊಳ್ಳಿ"
        NAMMA_SAFETY_PLUS -> "ಸೇಫ್ಟಿ+"
        TRIGGER_ALERT_TO_NAMMA_YATRI_SUPPORT_PLUS -> "ಯಾತ್ರಿ ಸಹಾಯದತ್ತ ಅಲರ್ಟ್ ಹಾಕಿ"
        TRIGGER_ALERT_TO_NAMMAYATRI_SUPPORT_TITLE_PLUS -> "ಯಾತ್ರಿ ಸಹಾಯದತ್ತ ಅಲರ್ಟ್ ಹಾಕಿ"
        SAFETY_GUIDELINES_6_PLUS -> "ಆಪ್ ಆತ್ಯಾವರ್ತನ ಸೇಫ್ಟಿ+ ವಿಶೇಷತೆಯನ್ನು ಬಳಸಿ"
        PERSONAL_SAFETY_SETTINGS_ACTIONS_PLUS -> " • ಪೊಲೀಸರಿಗೆ ಕರೆ ಮಾಡಿ (112)\n • ಸೈಲೆಂಟ್ SOS ಅನ್ನು ಪೊಲೀಸರಿಗೆ ಕಳುಹಿಸಿ\n • 15 ಸೆಕೆಂಡ್‌ಗಳ ಚಿಕ್ಕ ವೀಡಿಯೊವನ್ನು ರೆಕಾರ್ಡ್ ಮಾಡಿ."
        ENABLE_NIGHT_TIME_SAFETY_ALERTS_DESC_PLUS ->  "ಸುರಕ್ಷತೆ+ ಅನ್ನು ಸಕ್ರಿಯಗೊಳಿಸಲಾಗಿದೆಯೇ ಎಂಬುದನ್ನು ಲೆಕ್ಕಿಸದೆ"
        ALMOST_DONE_DESC_PLUS -> "ತುರ್ತು ಸಂದರ್ಭದಲ್ಲಿ, ಪರಿಸ್ಥಿತಿಯ ವಿಮರ್ಶಾತ್ಮಕತೆಯ ಆಧಾರದ ಮೇಲೆ ಈ ಯಾವುದೇ ಕ್ರಮಗಳನ್ನು ತೆಗೆದುಕೊಳ್ಳಬಹುದು"
        SEND_VIDEO_TO_POLICE -> "ಪೊಲೀಸರಿಗೆ\n15s ವೀಡಿಯೊ ಕಳುಹಿಸಿ"
        FINISH_SETUP -> "ಸೆಟಪ್ ಮುಗಿಸಿ"
        ACTIVATE_SOS -> "SOS ಅನ್ನು ಸಕ್ರಿಯಗೊಳಿಸಿ"
        ...
        NAMMA_SAFETY -> "ಸುರಕ್ಷತಾ ಮೋಡ್"
        COMPLETE_YOUR_NAMMA_SAFETY_SETUP_FOR_SAFE_RIDE_EXPERIENCE -> "ಸುರಕ್ಷತೆ ಸೆಟಪ್ ಮುಗಿಸಿ ಸುರಕ್ಷಿತ ರೈಡ್ ಅನುಭವ ಪಡೆಯಿರಿ"
        SAFETY_MEASURE_6 -> "ಸುರಕ್ಷಾ ಮೋಡ್ ಬಟನ್ ಮೇಲೆ ಟ್ಯಾಪ್ ಮಾಡಿ"
        CALL_SUPPORT_FOR_SAFETY -> "ನಮ್ಮ ಬೆಂಬಲಕ್ಕೆ ಕರೆ ಮಾಡಿ"