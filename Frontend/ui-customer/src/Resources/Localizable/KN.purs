...
getKN stringKey =
    case stringKey of
        ...
        ISSUE_SUBMITTED_TEXT -> "A moment, please! We are working on resolving your issue."
        CHOOSE_AN_OPTION -> "Select an option to proceed"
        RECORD_VOICE_NOTE -> "Record a voice note"
        MAX_IMAGES -> "You can upload a maximum of 3 images"
        YEARS_AGO -> "years ago"
        ...
        FARE_DISCREPANCIES_ISSUE_PAGE_NAME -> "Fare Discrepancies Issue"
        PAYMENT_RELATED_ISSUE_PAGE_NAME -> "Payment Related Issue"
        ACCOUNT_RELATED_ISSUE_PAGE_NAME -> "Account Related Issue"
        REPORT_ISSUE_CHAT_PLACEHOLDER _ -> ""
        CALL_SUPPORT_DESCRIPTION _ -> ""
