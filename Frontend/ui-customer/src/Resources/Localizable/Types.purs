...
getKeyString key = case key of
  ...
  ENABLE_LOCATION_PERMISSION_TO -> "ENABLE_LOCATION_PERMISSION_TO"
  PLEASE_ENABLE_LOCATION_PERMISSION -> "PLEASE_ENABLE_LOCATION_PERMISSION"
  AC_SUV -> "AC_SUV"
  AC_CAB -> "AC_CAB"
  RIDE_TYPE -> "RIDE_TYPE"
  ERNAKULAM_LIMIT_CHARGE -> "ERNAKULAM_LIMIT_CHARGE"
  SELECT_LOCATION_ON_MAP -> "SELECT_LOCATION_ON_MAP"
  DOWNLOAD_DRIVER_RECEIPT -> "DOWNLOAD_DRIVER_RECEIPT"
  VIEW_DRIVER_RECEIPT -> "VIEW_DRIVER_RECEIPT"
  ...
  DID_YOU_HAVE_A_SAFE_JOURNEY -> "DID_YOU_HAVE_A_SAFE_JOURNEY"
  TRIP_WAS_SAFE_AND_WORRY_FREE -> "TRIP_WAS_SAFE_AND_WORRY_FREE"
  DRIVER_BEHAVED_INAPPROPRIATELY -> "DRIVER_BEHAVED_INAPPROPRIATELY"
  I_DID_NOT_FEEL_SAFE -> "I_DID_NOT_FEEL_SAFE"
