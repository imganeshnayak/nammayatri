...
getHI stringKey =
    case stringKey of
        ...
        EDIT_ACTIONS -> "क्रियाएँ संपादित करें"
        ...
        CALL_POLICE -> "पुलिस हेल्पलाइन को कॉल करें\n(112)"
        ...
        SHARE_LOCATION_AND_RIDE_DETAILS_WITH_NAMMA_YATRI_SUPPORT_TEAM -> "नम्म यात्री समर्थन टीम के साथ स्थान और सवारी विवरण साझा करें"
        ...
        TRIGGER_ALERT_TO_NAMMA_YATRI_SUPPORT -> "नम्म यात्री समर्थन को सतर्क करें"
        ...
        TRIGGER_ALERT_TO_NAMMAYATRI_SUPPORT_TITLE -> "नम्म यात्री समर्थन को सतर्क करें"
        ...
        PERSONAL_SAFETY_SETTINGS_ACTIONS -> " •  112 को कॉल करें\n •  NammaYatri समर्थन को कॉल करें\n •  वीडियो रिकॉर्ड करें"
        ...
        SAFETY_MEASURE_5 -> "सभी नम्म यात्री ड्राइवरों के लिए सुरक्षा प्रशिक्षण और प्रमाणीकरण"
        ...
        ABOUT_SOS_11 -> "आपके परिवार और दोस्तों / नम्म यात्री समर्थन को आपातकालीन साझा करके सूचित करें।"
        ...
        SAFETY_PLUS_ACTIVE_DESC -> "कृपया शांत रहें। आपका SOS अनुरोध आपके आपातकालीन संपर्कों को भेज दिया गया है। आप यह भी चुन सकते हैं"
        CALL_AND_ALERT_THE_NEAREST_POLICE_CENTRE -> "कॉल करें और निकटतम पुलिस केंद्र को सचेत करें।"
        SEND_A_SILENT_SOS_TO_THE_POLICE -> "पुलिस को एक मूक SOS संदेश भेजें।"
        ...
        ABOUT_SOS_9_PLUS -> "सवारी के दौरान Safety+ बटन पर टैप करके Safety+ सक्रिय करें"
        ...
        ABOUT_SOS_12_PLUS -> "आप पुलिस हेल्पलाइन (112) पर कॉल करना चुन सकते हैं या उस पर एक साइलेंट SOS भेज सकते हैं"
        SAFETY_MEASURE_5_PLUS -> "सभी यात्री साथी ड्राइवरों के लिए सुरक्षा प्रशिक्षण और प्रमाणन"
        NAMMA_SAFETY_PLUS -> "सुरक्षा+"
        TRIGGER_ALERT_TO_NAMMA_YATRI_SUPPORT_PLUS -> "यात्री साथी समर्थन के लिए ट्रिगर अलर्ट"
        TRIGGER_ALERT_TO_NAMMAYATRI_SUPPORT_TITLE_PLUS -> "यात्री साथी समर्थन के लिए ट्रिगर अलर्ट"
        SAFETY_GUIDELINES_6_PLUS -> "इन-ऐप आपातकालीन सुरक्षा+ सुविधा का उपयोग करें"
        PERSONAL_SAFETY_SETTINGS_ACTIONS_PLUS -> " • पुलिस को कॉल करें (112)\n • पुलिस को साइलेंट एसओएस भेजें\n • एक छोटा 15 सेकंड का वीडियो रिकॉर्ड करें।"
        ENABLE_NIGHT_TIME_SAFETY_ALERTS_DESC_PLUS -> "आपकी सुरक्षा सुनिश्चित करने के लिए, रात 9 बजे से सुबह 6 बजे तक, हम ड्राइवर के मार्ग की विसंगति का पता लगाने के आधार पर सुरक्षा जांच अलर्ट भेजेंगे। मार्ग-विचलन के मामलों में या जब वाहन नहीं चल रहा हो।\n\n • यह होगा इस पर ध्यान दिए बिना कि सुरक्षा+ सक्रिय है या नहीं"
        ...
        NAMMA_SAFETY -> "सुरक्षा मोड"
        COMPLETE_YOUR_NAMMA_SAFETY_SETUP_FOR_SAFE_RIDE_EXPERIENCE -> "सुरक्षा मोड सेटअप पूरा करें"
        SAFETY_MEASURE_6 -> "ड्राइवर और ग्राहकों के लिए शून्य सहिष्णुता नीति"
        SHARE_LOCATION_AND_RIDE_DETAILS_WITH_NAMMA_YATRI_SUPPORT_TEAM_PLUS -> "यात्री साथी सहायता टीम के साथ स्थान और सवारी विवरण साझा करें"
        CALL_SUPPORT_FOR_SAFETY -> "हमारे हेल्पलाइन को कॉल करें"