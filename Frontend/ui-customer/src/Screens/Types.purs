...
import Common.Types.App (CountryCodeObj, OTPChannel, OptionButtonList, RateCardType, FeedbackAnswer, CarouselModal, CalendarModalDateObject, CalendarModalWeekObject)
...
type RentalConfig = {
  ...
  , endOdometer :: String
  , showScheduleRide :: Boolean
  , showRideCancelled :: Boolean
