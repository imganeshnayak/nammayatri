ALTER TABLE atlas_driver_offer_bpp.fare_parameters ADD column customer_cancellation_dues int;

ALTER TABLE atlas_driver_offer_bpp.transporter_config ADD column cancellation_fee int DEFAULT 10 NOT NULL;
ALTER TABLE atlas_driver_offer_bpp.transporter_config ADD column driver_distance_travelled_on_pickup_threshold bigint DEFAULT 500 NOT NULL;
ALTER TABLE atlas_driver_offer_bpp.transporter_config ADD column driver_time_spent_on_pickup_threshold int DEFAULT 600 NOT NULL;
...
ALTER TABLE atlas_driver_offer_bpp.transporter_config ADD column driver_distance_to_pickup_threshold int DEFAULT 50 NOT NULL;

ALTER TABLE atlas_driver_offer_bpp.rider_details ADD column cancellation_dues int DEFAULT 0 NOT NULL;
