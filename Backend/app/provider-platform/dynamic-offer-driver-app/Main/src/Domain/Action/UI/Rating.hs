...
rating :: (EsqDBFlow m r, EsqDBReplicaFlow m r, CoreMetrics m, HasFlowEnv m r '["appBackendBapInternal" ::: AppBackendBapInternal], CacheFlow m r, HasField "internalEndPointMap" r (HM.Map BaseUrl BaseUrl)) => CallBAPInternal.FeedbackReq -> m APISuccess
rating request = do
