...
arrivedAtPickup :: (EncFlow m r, CacheFlow m r, EsqDBFlow m r, EsqDBReplicaFlow m r, HasShortDurationRetryCfg r c, HasFlowEnv m r '["nwAddress" ::: BaseUrl], HasHttpClientOptions r c, HasFlowEnv m r '["driverReachedDistance" ::: HighPrecMeters], CacheFlow m r, HasField "internalEndPointMap" r (HM.Map BaseUrl BaseUrl)) => Id DRide.Ride -> LatLong -> m APISuccess
