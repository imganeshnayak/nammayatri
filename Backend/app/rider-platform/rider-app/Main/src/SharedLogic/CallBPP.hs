...
search gatewayUrl req = do
  ...
  callBecknAPIWithSignature req.context.bap_id "search" API.searchAPI gatewayUrl internalEndPointMap req
...
searchMetro gatewayUrl req = do
  internalEndPointMap <- asks (.internalEndPointMap)
  void $ callBecknAPIWithSignatureMetro "search" MigAPI.searchAPI gatewayUrl internalEndPointMap req
...
select providerUrl req = do
  internalEndPointMap <- asks (.internalEndPointMap)
  callBecknAPIWithSignature req.context.bap_id "select" API.selectAPI providerUrl internalEndPointMap req
...
init providerUrl req = do
  internalEndPointMap <- asks (.internalEndPointMap)
  callBecknAPIWithSignature req.context.bap_id "init" API.initAPI providerUrl internalEndPointMap req
...
confirm providerUrl req = do
  internalEndPointMap <- asks (.internalEndPointMap)
  callBecknAPIWithSignature req.context.bap_id "confirm" API.confirmAPI providerUrl internalEndPointMap req
...
cancel providerUrl req = do
  internalEndPointMap <- asks (.internalEndPointMap)
  callBecknAPIWithSignature req.context.bap_id "cancel" API.cancelAPI providerUrl internalEndPointMap req
...
update providerUrl req = do
  internalEndPointMap <- asks (.internalEndPointMap)
  callBecknAPIWithSignature req.context.bap_id "update" API.updateAPI providerUrl internalEndPointMap req
...
callTrack booking ride = do
  ...
  void . callBecknAPIWithSignature merchant.bapId "track" API.trackAPI booking.providerUrl internalEndPointMap =<< TrackACL.buildTrackReq trackBUildReq
...
callGetDriverLocation mTrackingUrl = do
  ...
  internalEndPointMap <- asks (.internalEndPointMap)
  callApiUnwrappingApiError (identity @TrackUrlError) Nothing (Just "TRACK_URL_NOT_AVAILABLE") (Just internalEndPointMap) trackingUrl eulerClient "BPP.driverTrackUrl" (Proxy @(Get '[JSON] GetLocationRes))
...
feedback providerUrl req = do
  internalEndPointMap <- asks (.internalEndPointMap)
  callBecknAPIWithSignature req.context.bap_id "feedback" API.ratingAPI providerUrl internalEndPointMap req
...
callStatus providerUrl req = do
  internalEndPointMap <- asks (.internalEndPointMap)
  callBecknAPIWithSignature req.context.bap_id "status" API.statusAPI providerUrl internalEndPointMap req
