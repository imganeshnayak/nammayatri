...
disputeCancellationDues (personId, merchantId) = do
  ...
  case (person.mobileNumber, person.mobileCountryCode) of
    (Just mobileNumber, Just countryCode) -> do
      CallBPPInternal.disputeCancellationDues merchant.driverOfferApiKey merchant.driverOfferBaseUrl merchant.driverOfferMerchantId mobileNumber countryCode
...
getCancellationDuesDetails (personId, merchantId) = do
  ...
  case (person.mobileNumber, person.mobileCountryCode) of
    (Just mobileNumber, Just countryCode) -> do
      res <- CallBPPInternal.getCancellationDuesDetails merchant.driverOfferApiKey merchant.driverOfferBaseUrl merchant.driverOfferMerchantId mobileNumber countryCode
